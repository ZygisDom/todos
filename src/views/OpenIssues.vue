<template>
    <section>
        <div class="home">
            <div class="container margin-top-7rem">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-10 col-md-8 col-sm-8" >
                        <div class="input-group mx-auto mb-5">
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="Enter The Task Here" v-model="newTask"></textarea>
                        <div class="input-group-append">
                            <button type="button" class="btn btn-info" @click="addTask"
                                                                        @keyup.enter="addTask">Add Task</button>
                        </div>
                        </div>
                    </div>
                </div>
